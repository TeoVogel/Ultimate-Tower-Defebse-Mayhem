...
public class FactoryAliado {
	...
	// VIDA: 100 | ATAQUE: 20 | CADENCIA: 20 | RANGO: 2 | PRECIO: 15
	public static Aliado crearSupport () {
		return new Aliado(10, 2, 20, 2, 15, "a1");
	}
	
	// VIDA: 80 | ATAQUE: 30 | CADENCIA: 35 | RANGO: 2 | PRECIO: 10
	public static Aliado crearCommando () {
		return new Aliado(80, 30, 35, 4, 10, "a2");
	}
	
	// VIDA: 100 | ATAQUE: 15 | CADENCIA: 25 | RANGO: 8 | PRECIO: 5
	public static Aliado crearSharpshooter () {
		return new Aliado(100, 15, 25, 8, 5, "a3");
	}
	
	// VIDA: 100 | ATAQUE: 15 | CADENCIA: 25 | RANGO: 8 | PRECIO: 10
	public static Aliado crearMago () {
		return new Aliado(70, 300, 50, 4, 10, "a4");
	}
	
	// VIDA: 100 | ATAQUE: 15 | CADENCIA: 25 | RANGO: 8 | PRECIO: 20
	public static AliadoDosCeldas crearTanque () {
		return new AliadoDosCeldas(200, 30, 30, 4, 20, "a6");
	}
